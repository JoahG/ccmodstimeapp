...
var getCurrentTime = function(offset) {
    ...
    return (currentTime.getHours().length > 1 ? currentTime.getHours() : "0" + currentTime.getHours()) + ":" + (currentTime.getMinutes().length > 1 ? currentTime.getMinutes() : "0" + currentTime.getMinutes()) + ":" + (currentTime.getSeconds().length > 1 ? currentTime.getSeconds() : "0" + currentTime.getSeconds()) + " (" + (offset >= 0 ? "+" + offset.toString(): offset.toString()) + ")";
}
